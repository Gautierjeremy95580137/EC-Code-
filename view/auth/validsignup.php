            ...
            <div class="form-group">
              <div class="row">
                <div class="col-md-6">
				  ...
				  <input type="submit" name="Valider2" onclick="index.php?action=inscription"; class="btn btn-block bg-red" />
				  <input type="submit" name="Valider3" onclick="index.php?action=inscription"; class="btn btn-block bg-red" />
				   <a href="index.php?action=inscription" class="btn btn-block bg-red">Inscription</a>
                </div>
                <div class="col-md-6">
